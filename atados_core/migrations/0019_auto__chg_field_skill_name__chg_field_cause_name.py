...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'atados_core_skill', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Cause.name'
        db.alter_column(u'atados_core_cause', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Skill.name'
        db.alter_column(u'atados_core_skill', 'name', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Cause.name'
        db.alter_column(u'atados_core_cause', 'name', self.gf('django.db.models.fields.CharField')(max_length=30))
