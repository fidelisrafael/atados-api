...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Address.addressline2'
        db.add_column(u'atados_core_address', 'addressline2',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Nonprofit.twitter_handle'
        db.alter_column(u'atados_core_nonprofit', 'twitter_handle', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
        # Deleting field 'Address.addressline2'
        db.delete_column(u'atados_core_address', 'addressline2')
