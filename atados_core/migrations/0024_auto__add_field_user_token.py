...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'atados_core_user', 'token',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=64, unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.token'
        db.delete_column(u'atados_core_user', 'token')
