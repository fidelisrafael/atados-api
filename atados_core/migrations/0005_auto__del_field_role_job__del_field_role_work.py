...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'atados_core_role', 'work_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'atados_core_role', 'job',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='Job', to=orm['atados_core.Job']),
                      keep_default=False)

        # Adding field 'Role.work'
        db.add_column(u'atados_core_role', 'work',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='Work', to=orm['atados_core.Work']),
                      keep_default=False)
