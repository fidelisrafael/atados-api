...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'atados_core_user', 'first_name')

        # Deleting field 'User.last_name'
        db.delete_column(u'atados_core_user', 'last_name')

        # Adding field 'User.name'
        db.add_column(u'atados_core_user', 'name',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'atados_core_user', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'User.last_name'
        db.add_column(u'atados_core_user', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Deleting field 'User.name'
        db.delete_column(u'atados_core_user', 'name')
