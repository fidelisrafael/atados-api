...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Volunteer.modified_date'
        db.add_column(u'atados_core_volunteer', 'modified_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 1, 15, 0, 0), blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Volunteer.modified_date'
        db.delete_column(u'atados_core_volunteer', 'modified_date')
