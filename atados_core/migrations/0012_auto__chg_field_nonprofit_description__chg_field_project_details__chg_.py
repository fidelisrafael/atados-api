...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Nonprofit.description'
        db.alter_column(u'atados_core_nonprofit', 'description', self.gf('django.db.models.fields.TextField')(max_length=160, null=True))

        # Changing field 'Project.details'
        db.alter_column(u'atados_core_project', 'details', self.gf('django.db.models.fields.TextField')(max_length=1024))

        # Changing field 'Project.description'
        db.alter_column(u'atados_core_project', 'description', self.gf('django.db.models.fields.TextField')(max_length=160, null=True))
        # Adding field 'Volunteer.birthDate'
        db.add_column(u'atados_core_volunteer', 'birthDate',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Nonprofit.description'
        db.alter_column(u'atados_core_nonprofit', 'description', self.gf('django.db.models.fields.TextField')(max_length=100, null=True))

        # Changing field 'Project.details'
        db.alter_column(u'atados_core_project', 'details', self.gf('django.db.models.fields.TextField')(max_length=3000))

        # Changing field 'Project.description'
        db.alter_column(u'atados_core_project', 'description', self.gf('django.db.models.fields.TextField')(max_length=100, null=True))
        # Deleting field 'Volunteer.birthDate'
        db.delete_column(u'atados_core_volunteer', 'birthDate')
