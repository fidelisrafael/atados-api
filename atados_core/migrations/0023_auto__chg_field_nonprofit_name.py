...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Nonprofit.name'
        db.alter_column(u'atados_core_nonprofit', 'name', self.gf('django.db.models.fields.CharField')(max_length=150))

    def backwards(self, orm):

        # Changing field 'Nonprofit.name'
        db.alter_column(u'atados_core_nonprofit', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))
