...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Nonprofit.highlighted'
        db.add_column(u'atados_core_nonprofit', 'highlighted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Project.highlighted'
        db.add_column(u'atados_core_project', 'highlighted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'User.name'
        db.alter_column(u'atados_core_user', 'name', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):
        # Deleting field 'Nonprofit.highlighted'
        db.delete_column(u'atados_core_nonprofit', 'highlighted')

        # Deleting field 'Project.highlighted'
        db.delete_column(u'atados_core_project', 'highlighted')


        # Changing field 'User.name'
        db.alter_column(u'atados_core_user', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))
