...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Address.longitude'
        db.alter_column(u'atados_core_address', 'longitude', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Address.latitude'
        db.alter_column(u'atados_core_address', 'latitude', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'Address.longitude'
        db.alter_column(u'atados_core_address', 'longitude', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Address.latitude'
        db.alter_column(u'atados_core_address', 'latitude', self.gf('django.db.models.fields.FloatField')(null=True))
