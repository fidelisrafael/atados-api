...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field companies on 'Nonprofit'
        m2m_table_name = db.shorten_name(u'atados_core_nonprofit_companies')
        ...
        db.create_unique(m2m_table_name, ['nonprofit_id', 'company_id'])


    def backwards(self, orm):
        # Removing M2M table for field companies on 'Nonprofit'
        db.delete_table(db.shorten_name(u'atados_core_nonprofit_companies'))
    ...
    models = {
        ...
        u'atados_core.comment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['atados_core.Project']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['atados_core.User']"})
        },
        ...
        u'atados_core.nonprofit': {
            ...
            'companies': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['atados_core.Company']", 'null': 'True', 'blank': 'True'}),
        ...
        u'atados_core.user': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '100'}),
            'token': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '64', 'unique': 'True', 'null': 'True'})
        },
