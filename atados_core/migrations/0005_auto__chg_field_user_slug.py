...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'User.slug'
        db.alter_column(u'atados_core_user', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=100))

    def backwards(self, orm):

        # Changing field 'User.slug'
        db.alter_column(u'atados_core_user', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))
