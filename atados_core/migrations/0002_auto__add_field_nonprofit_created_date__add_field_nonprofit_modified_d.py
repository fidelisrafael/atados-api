...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'atados_core_nonprofit', 'created_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 1, 15, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Nonprofit.modified_date'
        db.add_column(u'atados_core_nonprofit', 'modified_date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 1, 15, 0, 0), blank=True),
                      keep_default=False)


        # Changing field 'Nonprofit.twitter_handle'
        db.alter_column(u'atados_core_nonprofit', 'twitter_handle', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
        # Adding field 'Apply.status'
        db.add_column(u'atados_core_apply', 'status',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['atados_core.ApplyStatus']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Nonprofit.modified_date'
        db.delete_column(u'atados_core_nonprofit', 'modified_date')


        # Changing field 'Nonprofit.twitter_handle'
        db.alter_column(u'atados_core_nonprofit', 'twitter_handle', self.gf('django.db.models.fields.CharField')(max_length=51, null=True))
        # Deleting field 'Apply.status'
        db.delete_column(u'atados_core_apply', 'status_id')
