...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'atados_core_work', 'project_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['atados_core.Project'], unique=True))
        # Adding unique constraint on 'Work', fields ['project']
        db.create_unique(u'atados_core_work', ['project_id'])


        # Changing field 'Job.project'
        db.alter_column(u'atados_core_job', 'project_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['atados_core.Project'], unique=True))
        # Adding unique constraint on 'Job', fields ['project']
        db.create_unique(u'atados_core_job', ['project_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Job', fields ['project']
        db.delete_unique(u'atados_core_job', ['project_id'])

        # Removing unique constraint on 'Work', fields ['project']
        db.delete_unique(u'atados_core_work', ['project_id'])


        # Changing field 'Work.project'
        db.alter_column(u'atados_core_work', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['atados_core.Project']))

        # Changing field 'Job.project'
        db.alter_column(u'atados_core_job', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['atados_core.Project']))
    ...
    models = {
        ...
        u'atados_core.job': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['atados_core.Project']", 'unique': 'True', 'blank': 'True'}),
