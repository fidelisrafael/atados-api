...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'atados_core_work', 'project_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['atados_core.Project'], unique=True, null=True))

        # Changing field 'Job.project'
        db.alter_column(u'atados_core_job', 'project_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['atados_core.Project'], unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Work.project'
        db.alter_column(u'atados_core_work', 'project_id', self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['atados_core.Project'], unique=True))

        # Changing field 'Job.project'
        db.alter_column(u'atados_core_job', 'project_id', self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['atados_core.Project'], unique=True))
