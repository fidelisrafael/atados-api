...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'atados_core_company', (
        ...
        db.send_create_signal(u'atados_core', ['Company'])

        # Adding M2M table for field company on 'Project'
        m2m_table_name = db.shorten_name(u'atados_core_project_company')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm[u'atados_core.project'], null=False)),
            ('company', models.ForeignKey(orm[u'atados_core.company'], null=False))
        ))
        db.create_unique(m2m_table_name, ['project_id', 'company_id'])

        # Adding field 'User.company'
        db.add_column(u'atados_core_user', 'company',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['atados_core.Company'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Company'
        db.delete_table(u'atados_core_company')

        # Removing M2M table for field company on 'Project'
        db.delete_table(db.shorten_name(u'atados_core_project_company'))

        # Deleting field 'User.company'
        db.delete_column(u'atados_core_user', 'company_id')
    ...
    models = {
        ...
        u'atados_core.job': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['atados_core.Project']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
        ...
        u'atados_core.nonprofit': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'max_length': '160', 'null': 'True', 'blank': 'True'}),
        ...
        u'atados_core.project': {
            ...
            'company': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['atados_core.Company']", 'symmetrical': 'False'}),
            'created_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'deleted_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'max_length': '160', 'null': 'True', 'blank': 'True'}),
        ...
        u'atados_core.user': {
            ...
            'address': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['atados_core.Address']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'company': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['atados_core.Company']", 'null': 'True', 'blank': 'True'}),
        ...
        u'atados_core.volunteer': {
            ...
            'birthDate': ('django.db.models.fields.DateField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'causes': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['atados_core.Cause']", 'null': 'True', 'blank': 'True'}),
            'created_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
