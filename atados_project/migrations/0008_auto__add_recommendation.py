...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'atados_project_recommendation', (
        ...
        db.send_create_signal(u'atados_project', ['Recommendation'])


    def backwards(self, orm):
        # Deleting model 'Recommendation'
        db.delete_table(u'atados_project_recommendation')
    ...
    models = {
        ...
        u'atados_project.recommendation': {
