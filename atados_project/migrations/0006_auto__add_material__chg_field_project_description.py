...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'atados_project_material', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('donation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['atados_project.Donation'])),
        ...
        db.send_create_signal(u'atados_project', ['Material'])


        # Changing field 'Project.description'
        db.alter_column(u'atados_project_project', 'description', self.gf('django.db.models.fields.TextField')(max_length=75, null=True))

    def backwards(self, orm):
        # Deleting model 'Material'
        db.delete_table(u'atados_project_material')


        # Changing field 'Project.description'
        db.alter_column(u'atados_project_project', 'description', self.gf('django.db.models.fields.TextField')(max_length=100, null=True))
