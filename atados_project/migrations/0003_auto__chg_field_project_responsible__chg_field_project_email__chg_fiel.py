...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'atados_project_project', 'responsible', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Project.email'
        db.alter_column(u'atados_project_project', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True))

        # Changing field 'Project.phone'
        db.alter_column(u'atados_project_project', 'phone', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Project.responsible'
        raise RuntimeError("Cannot reverse this migration. 'Project.responsible' and its values cannot be restored.")
        ...
        # User chose to not deal with backwards NULL issues for 'Project.phone'
        raise RuntimeError("Cannot reverse this migration. 'Project.phone' and its values cannot be restored.")
