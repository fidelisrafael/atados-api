...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'atados_project_project', 'description',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'atados_project_project', 'description')
    ...
    models = {
        ...
        u'atados_project.project': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'max_length': '144', 'null': 'True', 'blank': 'True'}),
