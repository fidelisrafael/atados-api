...
from atados.core.views import HomeView, CityView, SuburbView, SearchView
...
urlpatterns = patterns(
    ...
    url(_(r'^terms$'), TemplateView.as_view(
        template_name='atados/core/terms.html'), name='terms'),

    url(_(r'^privacy$'), TemplateView.as_view(
        template_name='atados/core/privacy.html'), name='privacy'),

    url(_(r'^security$'), TemplateView.as_view(
        template_name='atados/core/security.html'), name='security'),

    url(_(r'^about$'), TemplateView.as_view(
        template_name='atados/core/about.html'), name='about'),
