...
from atados_nonprofit.forms import RegistrationForm
...
class RegistrationBackend(DefaultBackend):
    ...
    def post_activation_redirect(self, request, user):
        user.backend = 'atados_core.backends.AuthenticationBackend'
        login(request, user)
    ...
    def send_activation_email(self, user):
        ...
        try:
            ...
            message = render_to_string('atados_nonprofit/activation_email.txt',
                                       ctx_dict)
