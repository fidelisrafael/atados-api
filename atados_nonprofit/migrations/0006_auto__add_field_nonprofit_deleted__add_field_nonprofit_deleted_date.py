...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Nonprofit.deleted'
        db.add_column(u'atados_nonprofit_nonprofit', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Nonprofit.deleted_date'
        db.add_column(u'atados_nonprofit_nonprofit', 'deleted_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Nonprofit.deleted'
        db.delete_column(u'atados_nonprofit_nonprofit', 'deleted')

        # Deleting field 'Nonprofit.deleted_date'
        db.delete_column(u'atados_nonprofit_nonprofit', 'deleted_date')
