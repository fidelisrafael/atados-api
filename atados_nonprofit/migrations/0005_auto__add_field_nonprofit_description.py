...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Nonprofit.description'
        db.add_column(u'atados_nonprofit_nonprofit', 'description',
                      self.gf('django.db.models.fields.TextField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Nonprofit.description'
        db.delete_column(u'atados_nonprofit_nonprofit', 'description')
