...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Nonprofit.published'
        db.add_column(u'atados_nonprofit_nonprofit', 'published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Nonprofit.published'
        db.delete_column(u'atados_nonprofit_nonprofit', 'published')
