...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'atados_nonprofit_nonprofit', (
        ...
        db.send_create_signal(u'atados_nonprofit', ['Nonprofit'])

        # Adding M2M table for field causes on 'Nonprofit'
        db.create_table(u'atados_nonprofit_nonprofit_causes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('nonprofit', models.ForeignKey(orm[u'atados_nonprofit.nonprofit'], null=False)),
            ('cause', models.ForeignKey(orm[u'atados_core.cause'], null=False))
        ))
        db.create_unique(u'atados_nonprofit_nonprofit_causes', ['nonprofit_id', 'cause_id'])


    def backwards(self, orm):
        # Deleting model 'Nonprofit'
        db.delete_table(u'atados_nonprofit_nonprofit')

        # Removing M2M table for field causes on 'Nonprofit'
        db.delete_table('atados_nonprofit_nonprofit_causes')
